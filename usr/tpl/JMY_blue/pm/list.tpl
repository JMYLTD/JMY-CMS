...
<table class="table table-striped table-success table-bordered" width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#d2d2d4">
<thead>
...
[list]<tr bgcolor="#ffffff">
	<td width="120" style="text-align:center"><img src="{%AVATAR%}" alt="" style="border:1px #ccc solid; padding:2px; width:100px; height:100px;" /><br /><a href="profile/{%NICK%}">{%NICK%}</a></td>
...
<tr class="thNOanim" bgcolor="#f7f7f7">
	<td class="thNOanim" colspan="4" align="right">С отмеченными: <input type="submit" name="del" value="Удалить" class="btn btn-theme" onclick="return confirm('Увеерны что хотите удалить отмеченные сообщения?');" style="width:100px;"/> [initfrom]<input type="hidden" name="place" value="inbox"/><input type="submit" name="read" value="Прочитать" class="btn btn-theme" style="width:100px;"/>[/initfrom]</td>
	</tr>
</tbody>	
	</table></form>
</div>	
