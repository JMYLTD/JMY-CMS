<link href="{%THEME%}/assets/css/bb.css" rel="stylesheet" type="text/css" />
...
<textarea cols="30" rows="{%ROWS%}" name="{%NAME%}" class="{%CLASS%}" id="{%NAME%}" {%onclick%} onclick="mainArea('{%NAME%}')">{%TEXT%}</textarea>
</div>
