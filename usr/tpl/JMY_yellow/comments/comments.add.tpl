...
<tr><td width="150"><strong>Проверка </strong><span class="must" title="Обязательный пункт">*</span><br/>
{%CAPTCHA%}<br/></td>[captcha]<td align="left"><b>Повторите</b><span class="must" title="Обязательный пункт">*</span><br/>
<input name="securityCode" id="securityCode" type="text" maxlength="255" value="" /><br/>
<sup>Повторите код каптчи</sup></td>[/captcha]
</tr>
</table>
[/guest]
