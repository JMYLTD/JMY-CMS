...
<h3>Востановление пароля:</h3><br>
<form name="form" method="post" action="" enctype="multipart/form-data" onsubmit="showload();">
 <div class="register">
<div class="leftreg">E-mail</div><div class="rightreg">
<input name="email" id="email" type="text" class="inputreg" value="" />
<div class="descreg">Введите ваш email, зарегестрированный на сайте.</div></div>
</div>
<div class="register">
