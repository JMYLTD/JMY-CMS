[open]
<form  method="POST" action="pm/action">
...
<td class="thNOanim" colspan="4" align="right">С отмеченными: <input type="submit" name="del" value="Удалить" class="button button-red" onclick="return confirm('Увеерны что хотите удалить отмеченные сообщения?');" style="width:100px;"/> [initfrom]<input type="hidden" name="place" value="inbox"/><input type="submit" name="read" value="Прочитать" class="button button-green" style="width:100px;"/>[/initfrom]</td>
</tr>
</table>
</form>	
[/open]