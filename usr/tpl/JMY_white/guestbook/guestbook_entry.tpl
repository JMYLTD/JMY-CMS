...
<form action="guestbook/send" method="post" id="commentform" class="comment-form" novalidate="" onsubmit="return validate(this)" enctype="multipart/form-data">
			<p class="comment-notes">Обязательные поля помечены <span class="required" color="red">*</span></p>				<p class="comment-form-author">
